...
function DarkModeButton() {
  ...
  return (
    <button
      ...
      className={`relative transition-all w-10 h-5 ${isDarkMode?'bg-darkButton':'bg-lightButton'} bg-center bg-no-repeat bg-cover rounded-full flex items-center  z-20  sm:w-14 sm:h-6  lg:m-8 lg:h-6 lg:w-14  `}
    >
