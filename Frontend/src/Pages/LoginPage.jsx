...
function LoginPage() {
  ...
  const [text] = useTypewriter({
    ...
    typeSpeed:100,
    deleteSpeed:30,
    onLoopDone:()=>{console.log('Loop is completed');
    }
  ...
  return (
    ...
    >
      ...
      <div className=" h-[90%] flex items-center flex-col-reverse justify-around
                        sm:flex-col
      ...
      >
        ...
        <p className="text-[0.9rem]
          ...
          conversations with instant messaging, group chats, and a user-friendly
          interface. Built for speed and reliability, Chatify keeps you in
          sync, no matter where you are. Dive into meaningful interactions
          today!
        </p>
      </div>
